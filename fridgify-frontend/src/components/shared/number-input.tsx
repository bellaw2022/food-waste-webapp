...
export const NumberInput = ({ onDecrement, onIncrement, onSetValue, value }: 
    { onDecrement: () => void, onIncrement: () => void, onSetValue: (val: number) => void, value: number }
) => {
    ...
    return (
        <div className="flex flex-row items-center justify-center">
            ...
            <Input className="w-12 h-8 p-0 border-t-[1px] border-b-[1px] border-black/10 
                ...
                onBlur={reset}
            />
            <Button className="h-8 px-2 py-0 rounded-l-none" onClick={onIncrement}>+</Button>
        </div>
    )
};