...
//                     <Switch
//                         className="mr-5 bg-magenta"
//                         checked={wasteReductionReport}
//                         onCheckedChange={setWasteReductionReport}
//                     />
//                 </TableCell>
//             </TableRow>
//         </>
...
const ConnectInstagram = () => {
    return (
        <>
            <TableRow className="h-10 bg-lightGray">
                <TableCell className="text-lg font-bold text-magenta">Connect Instagram</TableCell>
            </TableRow>
            <TableRow className="h-12">
                <TableCell className="text-center" colSpan={2}>
                    <button className="px-4 py-2 bg-[#783C5B] text-white rounded-md hover:bg-[#65304C] transition duration-150">
                        Connect Instagram
                    </button>
                </TableCell>
            </TableRow>
